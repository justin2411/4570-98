...
import { Users, FileText, Phone, CheckCircle } from 'lucide-react'
...
export default async function AdminDashboard() {
  ...
  // Unique leads angerufen heute
  const callsToday = new Set((todayLog ?? []).filter(x => ['angerufen','nicht_erreicht','termin_gelegt','termin_stattgefunden'].includes(x.new_status)).map(x => x.lead_id)).size
  // Unique leads termin stattgefunden (aus leads-Tabelle wäre besser, aber hier aus log)
