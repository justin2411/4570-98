...
export const SCRIPT_SECTIONS: ScriptSection[] = [
  ...
  },
  {
    ...
    content: 'Ganz kurz, damit Sie mich einordnen: Wir arbeiten in einer offiziellen Kooperation mit dem Hebammen-Verband in {bundesland} zusammen. Im Rahmen dieser Kooperation melden wir uns einmal persönlich bei allen Hebammen im Verband — Sie sind eine davon.',
  },
  {
    id: 'problem',
    emoji: '💡',
